...
# model 5 - CIFAR10_pretrained
# Used model 4 but changed the last layer back to 10 outputs. Keep all other weights in the model the same as the CIFAR100_model 
class CifarPretrainedCNN(nn.Module):
